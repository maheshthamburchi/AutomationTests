Feature: Creating a New User
  ...
  Scenario: New User Creation
    ...
    Then User should verify the Page Title as "thermofisher.com Registration"
    ...
    Then User should verify the page title as "Account Dashboard | Thermo Fisher Scientific - US" 
    When User should click on Account
    Then User verify the Sign Out link
    Then User should verify the Page Title as "Thermo Fisher Scientific - IN"
